        ...
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-60 max-h-[60vh] overflow-y-auto">
                        <li><a href="#" class="flex items-center py-2"><i class='bx bx-food-menu mr-2'></i>Menu</a></li>
                        <li><a href="#" class="flex items-center py-2"><i class='bx bx-info-circle mr-2'></i>Tentang Kami</a></li>
                        <li><a href="#" class="flex items-center py-2"><i class='bx bx-gift mr-2'></i>Promo</a></li>
                        <li><a href="#" class="flex items-center py-2"><i class='bx bx-star mr-2'></i>Ulasan</a></li>
                        <li><a href="#" class="flex items-center py-2"><i class='bx bx-calendar mr-2'></i>Reservasi</a></li>
                    </ul>
                </div>

                <!-- Logo -->
                <a href="#" class="btn btn-ghost text-lg flex items-center p-0 sm:p-2">
            ...
            <div class="hidden lg:flex">
                <ul class="menu menu-horizontal px-1 gap-1">
                    <li><a href="#" class="hover:bg-base-200"><i class='bx bx-food-menu mr-1'></i>Menu</a></li>
                    <li><a href="#" class="hover:bg-base-200"><i class='bx bx-info-circle mr-1'></i>Tentang Kami</a></li>
                    <li><a href="#" class="hover:bg-base-200"><i class='bx bx-gift mr-1'></i>Promo</a></li>
                    <li><a href="#" class="hover:bg-base-200"><i class='bx bx-star mr-1'></i>Ulasan</a></li>
                    <li><a href="#" class="hover:bg-base-200"><i class='bx bx-calendar mr-1'></i>Reservasi</a></li>
                </ul>
            </div>
