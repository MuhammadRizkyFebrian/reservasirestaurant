<!--    Nama File: tentang_kamii.php
        Deskripsi: Halaman untuk menampilkan informasi tentang kami. 
    ...
    <!-- Navbar -->
        <div class="navbar">
            ...
            <div class="store-name">
                <a href="halaman_utama1.php" style="text-decoration: none; color: inherit;">
                Joyful & Cream
                </a>
            </div>
        </div>
